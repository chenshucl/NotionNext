...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '陈叔小站', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '陈叔的个人博客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '陈叔, 博客', // 网站关键词 英文逗号隔开
